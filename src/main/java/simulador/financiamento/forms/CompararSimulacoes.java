...
public class CompararSimulacoes extends JFrame {
    ...
    private JTable getComparisonJTable(Map<Integer, SistemaAmortizacao> simulationsMap) {
        ...
        for (int i = 0; i < simulationsMap.size(); i++) {
            ...
            row[2] = String.format("%.2f", sistemaAmortizacao.getValorImovel());
            row[3] = String.format("%.2f", sistemaAmortizacao.getValorPagoTotal());
            row[4] = String.format("%.2f", sistemaAmortizacao.getValorPagoTotal() / sistemaAmortizacao.getValorImovel());
            row[5] = String.format("%.2f", sistemaAmortizacao.getOpcoesAvancadas().getValorImovelValorizado());
            row[6] = String.format("%.2f", sistemaAmortizacao.getOpcoesAvancadas().getValorImovelInflacao());
